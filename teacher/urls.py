...
urlpatterns = [
    ...
    url(r'^exam/check/(?P<exam_id>\d+)/(?P<question_id>\d+)/$', login_required(views.exam_check)),  
    url(r'^exam/check/make/$', login_required(views.exam_check_make)),        
    ...
    url(r'^course/content/delete/(?P<classroom_id>\d+)/(?P<course_id>\d+)/(?P<content_id>\d+)/$', login_required(views.course_delete), name='course-content-delete'),   
    url(r'^course/content/edit/(?P<classroom_id>\d+)/(?P<course_id>\d+)/(?P<content_id>\d+)/$', login_required(views.course_edit), name='course-content-edit'),     
