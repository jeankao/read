...
from show.models import ShowGroup, ShowReview, Round
...
class ReviewUpdateView(UpdateView):
    ...
    def get(self, request, **kwargs):
        ...
        context = self.get_context_data(teacher=teacher,  show=show, form=form, members=members, review=self.object, scores=scores, score=score, reviews=reviews)
        return self.render(request, context)
